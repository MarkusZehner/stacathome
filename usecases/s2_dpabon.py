...
if __name__ == '__main__':
    ...
    file_path = os.path.join(
        notebook_dir, '/Net/Groups/BGI/scratch/mzehner/code/stacathome/usecases/danielPabon_missing_sites_post_2015.csv'
    )
    ...
    sel_bands = {
        'sentinel-2-l2a': list(get_attributes('sentinel-2-l2a')['data_attrs']['Band']),
        # 'modis-13Q1-061': {'250m_16_days_NDVI', '250m_16_days_EVI', '250m_16_days_VI_Quality'},
        # 'esa-worldcover': {'map'}
    }
    time_range = {
        'sentinel-2-l2a': (2014, 2025),
        # 'modis-13Q1-061': (2000, 2025),
        # 'esa-worldcover': (2021)
    }
    get_minicube(
        lat_lon_strings[start_index:end_index],
