...
from stacathome.processors.ecostress import (
    ecostress_pc_filter_newest_processing_iteration,
    update_tiled_data_from_raster,
)
...
class TestECO_L2T_LSTEProcessor:
    ...
    def test_filtering(self):
        ...
        geobox_small = create_test_geobox(
            shapely.Point(723311, 4635624), resolution=100, size_box=100, crs='EPSG:32632'
        )
