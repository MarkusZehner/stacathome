...
class TestSentinel2L2AProcessor:
    ...
    def test_filtering(self):
        ...
        assert {i.id for i in coverage_filtered_items} == set(filter_processing_time_coverage)
        assert {i.id for i in geometry_filtered_items} == set(filter_processing_time_coverage_geometry)
